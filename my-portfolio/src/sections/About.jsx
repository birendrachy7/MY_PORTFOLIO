...
const stats=[
  ...
  {label:"Speciality", value:"Problem Analysis"},
  {label:"Focus", value:"Security and Networking"},
]
...
<div className="absolute insert-0 pointer-events-none" >
  {glows.map((c,i)=>(
...
<p className="text-gray-300 leading-relaxed text-based sm:text-lg">I am a Computer Engineering student developing my skills in programming, networking, and cyber security. 
    My academic work has focused on areas such as data structures, problem solving, and web development while I continue expanding my knowledge in Linux systems and network security. </p>
