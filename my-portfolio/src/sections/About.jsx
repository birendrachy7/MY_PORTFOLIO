...
export default function About() {
  ...
  const stats = [
    ...
    { label: "Speciality", value: "Web Development & Problem Solving" },
    { label: "Focus", value: "AI/ML & Data Structures" },
  ];
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I am passionate about building modern web applications and solving real-world problems using Data Structures and Algorithms. 
              Alongside web development, I am exploring Artificial Intelligence and Machine Learning to understand how intelligent systems are built and applied.
            </p>
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            I am a Computer Engineering student focused on Web Development, Data Structures & Algorithms, and Artificial Intelligence/Machine Learning. 
            I enjoy building responsive and interactive web applications while strengthening my problem-solving skills through DSA practice. 
            My goal is to become a skilled software and AI engineer capable of developing impactful and intelligent systems.
          </p>
        </motion.div>
